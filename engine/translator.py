...
import engine.semantic_analysis
...
class Template:
    ...
    def __init__(self, template_path, variables_path, output_path):
        ...
        """
        scanner = engine.lexical_analysis.Scanner(template_path)
        self.parser = engine.syntactical_analysis.Parser(scanner)
        self.var_mgr = engine.symbol_table.VariableManager(variables_path)
        self.translator = engine.semantic_analysis.SemanticAnalyzer(self.parser, self.var_mgr)
